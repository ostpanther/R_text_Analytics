#1) Найдите самую грустную / негативную сказку. 
#Используйте любой словарь и любой осмысленный метод обобщения. 
#Ваш вывод должен быть прямо прописан в файле! (Оценка 0/1)
...
#суммарно она набрала -145 баллов - наивысший результат
