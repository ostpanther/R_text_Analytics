...
bibliography: /Users/gleb/Desktop/R/HW9/mybib.bib
---
...
Если вы захотите повторить проделанную работу, то можете заглянуть ко мне на github. (Скопируйте ссылку и вставьте ее в строку поиска.По другому R-pubs отказывается прикреплять гит).

>https://github.com/ostpanther/text_analytics.git
